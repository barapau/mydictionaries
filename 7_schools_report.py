...
#how many schools are in these file 
print(len(schools))
...
for school in schools:
    if school['NCAA']["NAIA conference number football (IC2020)"] in conference_schools:
        if str(school["Total price for in-state students living off campus (not with family)  2020-21 (DRVIC2020)"]).isdigit() and school["Total price for in-state students living off campus (not with family)  2020-21 (DRVIC2020)"]>50000:
                print(school['instnm'])
                print(school["Total price for in-state students living off campus (not with family)  2020-21 (DRVIC2020)"])
                print()
                print()
